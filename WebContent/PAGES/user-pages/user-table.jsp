...
<div class="row row-cols-2 mt-3">
	...
	<div class="container text-right">
		<button type="button" class="btn btn-success" title="Add user" onClick="userOption('Add');">
				<i class="fa fa-plus-square" aria-hidden="true"></i>
		</button>
		<button type="button" class="btn btn-info" title="Edit user">
...
$(document).ready(function(){
	$("#selectAll").on("click", function(){
		$(".users-col input[type=checkbox]").each(function(){
